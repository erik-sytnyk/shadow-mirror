...
- Hero section with reader-facing provocative copy
- "Open Mirror" button transitions from hero to chat
- Pulsing blue glow effect on chat container
- Fade-in animations for messages
- Auto-resizing textarea input
- Error handling and loading states
- Dark theme: black background, zinc tones, blue-900 accents
